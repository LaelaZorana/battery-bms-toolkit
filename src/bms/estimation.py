...
import numpy as np
from .ecm import ECMParams, ocv, docv_dsoc
...
class CapacityRLS:
    """Recursive least squares on Q from delta_soc = -Ah / Q, using y = Ah, phi = -delta_soc.

    Model: charge_ah = Q * (soc_start - soc_end). Estimate Q with forgetting factor.
    """
